				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="mobileNo"
							pattern="[789][0-9]{9}" placeholder="Enter Contact No Here"
							required></td>
					</tr>
					...
					<tr>
						...
						<td><input type="date" name="birthDate" max="2025-06-04"
							min="1900-01-01" required></td>
					</tr>
					...
					<tr>
                   	...
                   	<tr>
						<td><input style="background-color: blue;" type="submit"
							value="Register" name="submit"></td>
						<td><input style="background-color: red;" type="reset">
						</td>
